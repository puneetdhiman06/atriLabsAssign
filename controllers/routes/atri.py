...
class Atri:
	def __init__(self, state: Any):
		...
		self.readArticleDiv = state["readArticleDiv"]
		...
		self.buttonDown = state["buttonDown"]
		...
		self.UnorderedList16 = state["UnorderedList16"]
	...
	@property
	def readArticleDiv(self):
		self._getter_access_tracker["readArticleDiv"] = {}
		return self._readArticleDiv
	@readArticleDiv.setter
	def readArticleDiv(self, new_state):
		self._setter_access_tracker["readArticleDiv"] = {}
		global default_state
		self._readArticleDiv = Div(new_state, default_state["readArticleDiv"])
	...
	def left(self, new_state):
		...
		global default_state
		self._left = Div(new_state, default_state["left"])
	...
	def main(self, new_state):
		...
		global default_state
		self._main = Div(new_state, default_state["main"])
	...
	def right(self, new_state):
		...
		global default_state
		self._right = Div(new_state, default_state["right"])
	...
	def service(self, new_state):
		...
		global default_state
		self._service = Div(new_state, default_state["service"])
	...
	@property
	def buttonDown(self):
		self._getter_access_tracker["buttonDown"] = {}
		return self._buttonDown
	@buttonDown.setter
	def buttonDown(self, new_state):
		self._setter_access_tracker["buttonDown"] = {}
		global default_state
		self._buttonDown = Div(new_state, default_state["buttonDown"])
	...
	@property
	def UnorderedList16(self):
		self._getter_access_tracker["UnorderedList16"] = {}
		return self._UnorderedList16
	@UnorderedList16.setter
	def UnorderedList16(self, new_state):
		self._setter_access_tracker["UnorderedList16"] = {}
		global default_state
		self._UnorderedList16 = UnorderedList(new_state, default_state["UnorderedList16"])
	...
	def _to_json_fields(self):
		return {
			...
			"Div103": self._Div103,
			"Div101": self._Div101,
			"readArticleDiv": self._readArticleDiv,
			"Div133": self._Div133,
			"Div135": self._Div135,
			"Div136": self._Div136,
			"Div137": self._Div137,
			...
			"UnorderedList16": self._UnorderedList16,
